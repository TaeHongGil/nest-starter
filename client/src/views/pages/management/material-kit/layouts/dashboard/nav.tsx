...
import { usePathname } from '@root/views/pages/management/material-kit/routes/hooks';
...
export function NavDesktop({ sx, data, slots, workspaces, layoutQuery }: NavContentProps & { layoutQuery: Breakpoint }) {
...
export function NavMobile({ sx, data, open, slots, onClose, workspaces }: NavContentProps & { open: boolean; onClose: () => void }) {
