...
import type { PaletteColorKey } from '@root/views/pages/management/material-kit/theme/core';
...
import { fNumber, fPercent, fShortenNumber } from '@root/views/pages/management/material-kit/utils/format-number';

import { Chart, useChart } from '@root/views/pages/management/material-kit/components/chart';
...
export function AnalyticsWidgetSummary({ sx, icon, title, total, chart, percent, color = 'primary', ...other }: Props) {
